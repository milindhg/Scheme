...
if(!_data) {
  ...
  _data->tag = _innerr_ratorr_rand_cont;
...
if(!_data) {
  ...
  _data->tag = _outerr_ratorr_rand_cont;
...
k = (void *)contr_innerr_ratorr_rand(v,kr__ex__);
expr = (void *)rand;
env = (void *)envr__ex__;
pc = &valuer__m__ofr__m__cps;
break; }
...
k = (void *)contr_innerr_if(conseq,alt,env,k);
expr = (void *)test;
pc = &valuer__m__ofr__m__cps;
break; }
case _mult_exp: {
...
k = (void *)contr_outerr_mult(randr2,env,k);
expr = (void *)randr1;
pc = &valuer__m__ofr__m__cps;
break; }
case _subr1_exp: {
void *rand = _c->u._subr1._rand;
k = (void *)contr_innerr_subr1(k);
expr = (void *)rand;
pc = &valuer__m__ofr__m__cps;
break; }
case _zero_exp: {
void *rand = _c->u._zero._rand;
k = (void *)contr_innerr_zero(k);
expr = (void *)rand;
pc = &valuer__m__ofr__m__cps;
break; }
case _capture_exp: {
...
k = (void *)contr_innerr_return(vexp,env);
expr = (void *)kexp;
pc = &valuer__m__ofr__m__cps;
break; }
case _let_exp: {
...
k = (void *)contr_innerr_let(body,env,k);
expr = (void *)vexp;
pc = &valuer__m__ofr__m__cps;
break; }
case _lambda_exp: {
...
k = (void *)contr_outerr_ratorr_rand(rand,env,k);
expr = (void *)rator;
pc = &valuer__m__ofr__m__cps;
break; }
}
